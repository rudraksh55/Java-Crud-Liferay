...
import com.employee.service.service.persistence.impl.constants.TestEmployeePersistenceConstants;
...
public class EmployeePersistenceImpl
	...
	@Override
	@Reference(
		target = TestEmployeePersistenceConstants.SERVICE_CONFIGURATION_FILTER,
		unbind = "-"
	)
	...
	@Override
	@Reference(
		target = TestEmployeePersistenceConstants.ORIGIN_BUNDLE_SYMBOLIC_NAME_FILTER,
		unbind = "-"
	)
	...
	static {
		try {
			Class.forName(TestEmployeePersistenceConstants.class.getName());
		}
